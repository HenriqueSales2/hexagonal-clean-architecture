package br.com.sales.hexagonal_architecture_demo.infrastructure.output.event;
...
@Component
public class LoggingProductEventPublish implements ProductEventPublisher {

    private static final Logger log = LoggerFactory.getLogger(LoggingProductEventPublish.class);
